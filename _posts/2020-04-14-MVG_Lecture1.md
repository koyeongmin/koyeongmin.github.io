...
또한 여기서 $\alpha \equiv V^T x$를 basis V에서본 x의 coefficient, $\beta \equiv U^T y$를 basis U에서본 y의 coefficient라고 할 때, circle은 $\mid x \mid^2_2 = \Sigma_i \alpha^2_i = 1$ 이며, 위의 관계식에서 다음이 성립합니다.
